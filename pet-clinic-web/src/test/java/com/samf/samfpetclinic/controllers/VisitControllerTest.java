...
import com.samf.samfpetclinic.services.PetService;
...
class VisitControllerTest {
    ...
    private static final String PETS_CREATE_OR_UPDATE_VISIT_FORM = "pets/createOrUpdateVisits";
    ...
    void setUp() {
        ...
        visit = Visit.builder()
                .date(LocalDate.now())
                .description(YET_ANOTHER_VISIT_DESCRIPTION)
                .pet(new Pet())
                .build();
